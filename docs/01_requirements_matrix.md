...
| HW-F16 | 3-stage rollout: local → cloud → bonus competition | `docs/06_submission_checklist.md`, PRD-007, `Dockerfile`, `render.yaml` | 10,14 | 🟨 (Stage 1 local: ✅ done and proven; Stage 2 cloud: code/container/Blueprint done and ✅, actual deployment requires the user's own Render account — not something I can perform autonomously; Stage 3 bonus: external, HW-Q06) |
